...
1. On the **Identity Governance | Getting Started** page, in the left navigation, under **Access reviews** select **Settings**.
...
1. If you want to remove the guest user account in this directory, you can set the number of days before it is removed. If you want to remove the guest user account as soon as they lose their last assignment to any access packages, set **Number of days before removing external user from directory** to **0**.
