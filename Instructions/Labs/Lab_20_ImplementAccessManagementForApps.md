...
lab:
  ...
  description: Your organization requires that only specific users or groups have
    access to enterprise applications. You must assign a user to a specific application.
  duration: 5 minutes
  level: 100
  islab: true
---
