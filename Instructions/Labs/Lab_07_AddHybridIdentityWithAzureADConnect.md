...
lab:
  ...
  description: In this task, you will configure Azure AD Connect attribute level filtering that will limit synchronization of user accounts to those with the UPN suffix matching the custom domain name of the target Azure AD tenant.
  duration: 60 minutes
  level: 300
  islab: true
  primarytopics:
