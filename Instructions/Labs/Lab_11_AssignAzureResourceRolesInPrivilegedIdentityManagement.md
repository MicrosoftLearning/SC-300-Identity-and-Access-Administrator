...
lab:
  ...
  description: 'Microsoft Entra Privileged Identity Management (PIM) can manage the
    built-in Azure resource roles, as well as custom roles, including (but not limited
    to):'
  duration: 10 minutes
  level: 200
  islab: true
