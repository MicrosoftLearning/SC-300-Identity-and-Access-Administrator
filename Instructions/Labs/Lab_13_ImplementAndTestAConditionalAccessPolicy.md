...
lab:
  ...
  description: Your organization needs to be able to limit user access to its internal
    applications. You must deploy an Microsoft Entra conditional access policy.
  duration: 20 minutes
  level: 300
  islab: true
  primarytopics:
