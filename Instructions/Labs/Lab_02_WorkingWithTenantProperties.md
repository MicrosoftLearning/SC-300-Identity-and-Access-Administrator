...
1. Enter the subdomain name `sales.tenantname.onmicrosoft.com` into the dialog. Remember to replace the tenant name with your actual tenant name.
...
1. Record the tenant id in a text file in the lab virtual machine. You will need it in a later lab.
